...
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if (HAL_RTC_GetTime(hrtc, &stime, RTC_FORMAT_BIN) != HAL_OK)
  {
    return HAL_ERROR;
        ...
        // if ( (stime.Seconds >=0 ) && ( stime.Seconds <= 9 ) ){
        //         stime.Seconds    =  0 ;
        // }
        // else if ((stime.Seconds >=10 ) && ( stime.Seconds <= 19 )){
        //         stime.Seconds    =  10 ;
        // }
        // else if ((stime.Seconds >=20 ) && ( stime.Seconds <= 29 )){
        //         stime.Seconds    =  20 ;
        // }
        // else if ((stime.Seconds >=30 ) && ( stime.Seconds <= 39 )){
        //         stime.Seconds    =  30 ;
        // }

        // else if ((stime.Seconds >=40 ) && ( stime.Seconds <= 49 )){
        //         stime.Seconds     =  40 ;
        // }
        
        // else if ((stime.Seconds >=50 ) && ( stime.Seconds <= 59 )){
        //         stime.Seconds    =  50 ;
        // }
        // else{
        //         stime.Seconds     =  0 ;    
